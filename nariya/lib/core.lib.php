...
// 배열 생성
function na_array($str, $delimiter='|') {
	...
	for($i=0; $i < $rows_cnt; $i++) {
		$row = na_explode($delimiter, $rows[$i]);
...
// 배열 생성
function na_array_key($str, $delimiter='|') {
