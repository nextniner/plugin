...
function na_script($id, $opt=''){
	...
	if($id == 'kakaotalk') {
		...
		if(!defined('NA_INFINITESCROLL')) {
			define('NA_INFINITESCROLL', true);
			add_javascript('<script src="https://unpkg.com/infinite-scroll@4/dist/infinite-scroll.pkgd.min.js"></script>', 0);
		}
