...
if(isset($_POST['act_button']) && isset($_POST['token'])){
    ...
    for ($i = 0; $i < $post_count_chk; $i++) {
        ...
        $post_co_level = isset($_POST['co_level'][$k]) ? (int)$_POST['co_level'][$k] : 0;

	    sql_query(" update {$g5['content_table']} set co_shop = '{$post_co_shop}', co_level = '{$post_co_level}' where co_id = '{$post_co_id}' ");
