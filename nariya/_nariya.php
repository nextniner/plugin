...
// 레벨
(isset($nariya['xp_point']) && (int)$nariya['xp_point'] > 0) ? define('IS_EXP', true) : define('IS_EXP', false);
...
if(IS_YC) {
	$replace_shop_file = array(
		G5_SHOP_DIR.'-shop-list', // 상품목록 페이지
		G5_SHOP_DIR.'-shop-item', // 상품상세페이지(PC)
		G5_SHOP_DIR.'-page-item', // 상품상세페이지(모바일)
		G5_SHOP_DIR.'-page-itemuse', // 상품상세 페이지의 상품후기
		G5_SHOP_DIR.'-page-itemuselist', // 상품후기
		G5_SHOP_DIR.'-page-itemqa', // 상품상세 페이지의 상품문의
		G5_SHOP_DIR.'-page-itemqalist', // 상품문의
